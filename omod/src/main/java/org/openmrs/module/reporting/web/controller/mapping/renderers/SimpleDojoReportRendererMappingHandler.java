...
/**
 * Handler that determines what page is used to edit/create a new SimpleHtmlReportRenderer
 */

@Handler(supports=SimpleDojoReportRenderer.class, order=50)
public class SimpleDojoReportRendererMappingHandler extends RendererMappingHandler {
